                ...
                <div className='popup-inner'>
                    <div className="texto-img">
                            <div className='texto'>
                                ...
                                <p className='conteudo paragrafo'>Para maiores informações e detalhes sobre o processo de Discovery, <a href='https://ftomoda.notion.site/ftomoda/8-ODS-Emprego-Digno-e-Crescimento-Econ-mico-021337c08d3e43aca6a6de645784beb3' target="_blank">clique aqui</a>.</p>
                            </div>
